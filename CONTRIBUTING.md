# Contributing to agentsql
First off, thank you for considering contributing to agentsql. 
It's people like you that make agentsql great!
...
```bash
git clone https://github.com/cryptopatrick/agentsql.git
cd agentsql
```
...
To run agentsql, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/agentsql/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/agentsql/issues) to report any bugs or request new features.
...
Thank you for contributing to agentsql!
